...
def process_document(document):
    ...
    doc_as_chunks = structured_llm.invoke(prompt)
    return [chunk.as_document(document) for chunk in doc_as_chunks.chunks]
...
def create_vectorstore(chunks: list[Document]):
    # Delete existing vectorstore if present
    existing = Chroma(
    ...
    # Create fresh vectorstore from documents
